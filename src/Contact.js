            ...
            <div>
                ...
                <img src={pub + "/img/svg/youtubelogo.svg"}/>
                    <div className="social">
                        <a href="https://github.com/SinclairHudson"><img src={pub + "/img/svg/githublogo.svg"}/></a>
                    </div>
                    <div className="social">
                        <a href="https://www.facebook.com/people/Sinclair-Hudson/100011751077436"><img
                            src={pub + "/img/svg/facebooklogo.svg"}/></a>
                    </div>
                    <div className="social">
                        <a href="https://www.youtube.com/channel/UCk8n3-SC7fYYpLQkT0eYicA"><img
                            src={pub + "/img/svg/youtubelogo.svg"}/></a>
                    </div>
                    <div className="social">
                        <a href="https://www.linkedin.com/in/sinclair-h-490002130/"><img
                            src={pub + "/img/svg/linkedinlogo.svg"}/></a>
                    </div>
                    <div className="social">
                        <a href="https://devpost.com/SinclairHudson"><img src={pub + "/img/svg/devpost.svg"}/></a>
                    </div>
                </div>
            </div>
        );
